import { r as t, i, h as o, H as e, e as n, d as r } from "./p-5701584d.js";
import { b as a, c as l } from "./p-22f1ceb4.js";
import { o as s, c as d, h as g } from "./p-2722d382.js";
const m = class {
  constructor(i) {
    t(this, i), this.itemStyles = new Map(), this.multipleInputs = !1, this.button = !1, this.detailIcon = "chevron-forward", this.disabled = !1, this.routerDirection = "forward", this.type = "button";
  }
  ...
  itemStyle(t) {
    ...
    }), a || Object.keys(n).length === Object.keys(r).length || (a = !0), a && (this.itemStyles.set(o, n), i(this));
  }
  ...
  componentDidLoad() {
    ...
    this.multipleInputs = t.length + i.length > 1 || t.length + o.length > 1 || t.length > 0 && this.isClickable();
  }
  ...
  render() {
    const {
      ...
      target: c
          ...
          k = void 0 !== t ? t : "ios" === f && x;
    return this.itemStyles.forEach(t => {
      Object.assign(p, t);
    }), o(e, {
      "aria-disabled": l ? "true" : null,
      class: Object.assign(Object.assign(Object.assign({}, p), d(this.color)), {
        item: !0,
        [f]: !0,
    ...
    })), v && "md" === f && o("ion-ripple-effect", null)), o("div", {
...
const b = class {
  constructor(i) {
    t(this, i), this.noAnimate = !1, this.ionStyle = r(this, "ionStyle", 7);
  }
...
const v = class {
  constructor(i) {
    t(this, i), this.animated = !1;
  }

  render() {
    const t = this.animated && l.getBoolean("animated", !0),
          i = g("ion-avatar", this.el) || g("ion-thumbnail", this.el),
          n = a(this);
    return o(e, {
      class: {
        [n]: !0,
...
export { m as ion_item, h as ion_item_divider, c as ion_item_group, b as ion_label, p as ion_list, f as ion_list_header, x as ion_note, v as ion_skeleton_text };