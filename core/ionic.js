...
(function () {
  var currentScript = document.currentScript; // Safari 10 support type="module" but still download and executes the nomodule script
  ...
  if (!currentScript || !currentScript.hasAttribute('nomodule') || !('onbeforeload' in currentScript)) {
    ...
    */
    ...
    }("undefined" != typeof window && window); // Figure out currentScript (for IE11, since it does not support currentScript)
    ...
    var start = function () {
      var url = new URL('./p-fea6aa49.system.js', resourcesUrl);
