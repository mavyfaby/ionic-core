import { r as t, d as i, f as e, h as a, H as o, e as n } from "./p-5701584d.js";
import { b as s } from "./p-22f1ceb4.js";
import { d as r, f as d } from "./p-502e7dbf.js";
import { c as h } from "./p-2722d382.js";
const l = class {
  constructor(e) {
    t(this, e), this.inputId = `ion-input-${p++}`, this.didBlurAfterEdit = !1, this.hasFocus = !1, this.autocapitalize = "none", this.autofocus = !1, this.clearOnEdit = !1, this.debounce = 0, this.disabled = !1, this.name = this.inputId, this.readonly = !1, this.required = !1, this.spellcheck = !1, this.autoGrow = !1, this.value = "", this.onInput = t => {
      this.nativeInput && (this.value = this.nativeInput.value), this.emitStyle(), this.ionInput.emit(t);
    }, this.onFocus = () => {
      this.hasFocus = !0, this.focusChange(), this.ionFocus.emit();
    }, this.onBlur = () => {
      this.hasFocus = !1, this.focusChange(), this.ionBlur.emit();
    }, this.onKeyDown = () => {
      this.checkClearOnEdit();
    }, this.ionChange = i(this, "ionChange", 7), this.ionInput = i(this, "ionInput", 7), this.ionStyle = i(this, "ionStyle", 7), this.ionBlur = i(this, "ionBlur", 7), this.ionFocus = i(this, "ionFocus", 7);
  }

  debounceChanged() {
    this.ionChange = r(this.ionChange, this.debounce);
  }
  ...
  valueChanged() {
    const t = this.nativeInput,
          i = this.getValue();
    t && t.value !== i && (t.value = i), this.runAutoGrow(), this.emitStyle(), this.ionChange.emit({
      value: i
    });
  }

  connectedCallback() {
    this.emitStyle(), this.debounceChanged(), document.dispatchEvent(new CustomEvent("ionInputDidLoad", {
      detail: this.el
    }));
  }
  ...
  runAutoGrow() {
    const t = this.nativeInput;
    t && this.autoGrow && e(() => {
      t.style.height = "auto", t.style.height = t.scrollHeight + "px", this.textareaWrapper && (this.textareaWrapper.style.height = t.scrollHeight + "px");
    });
  }
  ...
  checkClearOnEdit() {
    this.clearOnEdit && (this.didBlurAfterEdit && this.hasValue() && (this.value = ""), this.didBlurAfterEdit = !1);
  }
