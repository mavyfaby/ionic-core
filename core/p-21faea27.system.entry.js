System.register(["./p-f98a0e28.system.js", "./p-0318c166.system.js", "./p-336ee3a9.system.js", "./p-f709d13b.system.js"], function (a) {
  "use strict";

  var r, e, o, i, n, t, s, c, h, l, b;
  return {
    setters: [function (a) {
      r = a.r;
      e = a.d;
    ...
    execute: function () {
      ...
      const u = a("ion_searchbar", class {
        constructor(a) {
          ...
          this.cancelButtonIcon = s.get("backButtonIcon", "arrow-back-sharp");
          ...
          this.ionInput = e(this, "ionInput", 7);
          this.ionChange = e(this, "ionChange", 7);
          this.ionCancel = e(this, "ionCancel", 7);
          this.ionClear = e(this, "ionClear", 7);
          this.ionBlur = e(this, "ionBlur", 7);
          this.ionFocus = e(this, "ionFocus", 7);
          this.ionStyle = e(this, "ionStyle", 7);
        }

        debounceChanged() {
          this.ionChange = h(this.ionChange, this.debounce);
        }
        ...
        positionElements() {
          const a = this.getValue();
          const r = this.shouldAlignLeft;
          const e = c(this);
          const o = !this.animated || a.trim() !== "" || !!this.focused;
        ...
        positionPlaceholder() {
          ...
          const r = document.dir === "rtl";
          const e = (this.el.shadowRoot || this.el).querySelector(".searchbar-search-icon");
          ...
          if (this.shouldAlignLeft) {
            ...
            l(() => {
              ...
              i.remove();
              const n = "calc(50% - " + o / 2 + "px)";
              const t = "calc(50% - " + (o / 2 + 30) + "px)";

              if (r) {
                a.style.paddingRight = n;
                e.style.marginRight = t;
              } else {
                a.style.paddingLeft = n;
                e.style.marginLeft = t;
              }
            });
          }
        }
        ...
        positionCancelButton() {
          const a = document.dir === "rtl";
          const r = (this.el.shadowRoot || this.el).querySelector(".searchbar-cancel-button");
          const e = this.shouldShowCancelButton();

          if (r && e !== this.isCancelVisible) {
            const o = r.style;
            this.isCancelVisible = e;
        ...
        render() {
          const a = this.animated && s.getBoolean("animated", true);
          const r = c(this);
          const e = this.clearIcon || (r === "ios" ? "close-circle" : "close-sharp");
          const o = this.searchIcon || (r === "ios" ? "search-outline" : "search-sharp");
          const t = this.showCancelButton !== "never" && i("button", {
            "aria-label": "cancel",
            type: "button",
            tabIndex: r === "ios" && !this.shouldShowCancelButton() ? -1 : undefined,
            onMouseDown: this.onCancelSearchbar,
            onTouchStart: this.onCancelSearchbar,
            class: "searchbar-cancel-button"
          }, i("div", null, r === "md" ? i("ion-icon", {
            "aria-hidden": "true",
            mode: r,
