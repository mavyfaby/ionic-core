import { r as i, h as r, H as t } from "./p-5701584d.js";
import { c as e, b as n } from "./p-22f1ceb4.js";
import { c as a } from "./p-502e7dbf.js";
import { c as s } from "./p-2722d382.js";

const o = class {
  constructor(r) {
    i(this, r), this.type = "determinate", this.reversed = !1, this.value = 0, this.buffer = 1;
  }
  ...
  render() {
    const {
      ...
      buffer: f
          ...
          l = e.getBoolean("_testing"),
          u = n(this);
    return r(t, {
      role: "progressbar",
      "aria-valuenow": "determinate" === a ? c : null,
      "aria-valuemin": "0",
      "aria-valuemax": "1",
      class: Object.assign(Object.assign({}, s(i)), {
        [u]: !0,
        [`progress-bar-${a}`]: !0,
        "progress-paused": l,
        "progress-bar-reversed": "rtl" === document.dir ? !o : o
      })
    }, "indeterminate" === a ? m() : b(c, f));
  }
