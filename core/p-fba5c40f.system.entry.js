    ...
    execute: function () {
      ...
      const h = t("ion_input", class {
        constructor(t) {
          ...
          this.onKeydown = t => {
            if (this.shouldClearOnEdit()) {
              if (this.didBlurAfterEdit && this.hasValue() && t.key !== "Enter") {
                this.clearTextInput();
              }
          ...
          this.clearTextInput = t => {
            if (this.clearInput && !this.readonly && !this.disabled && t) {
              t.preventDefault();
              t.stopPropagation();
            }
        ...
        shouldClearOnEdit() {
          ...
          return i === undefined ? t === "password" : i;
        }
        ...
        render() {
          ...
          return e(o, {
            ...
            class: Object.assign(Object.assign({}, p(this.color)), {
              [t]: true,
              "has-value": this.hasValue(),
              "has-focus": this.hasFocus
            })
          ...
          }), this.clearInput && !this.readonly && !this.disabled && e("button", {
            type: "button",
