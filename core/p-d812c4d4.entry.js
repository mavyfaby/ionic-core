...
const b = class {
  ...
  positionElements() {
    ...
    this.shouldAlignLeft = o, "ios" === i && (r !== o && this.positionPlaceholder(), this.animated && this.positionCancelButton());
  }
  ...
  positionPlaceholder() {
    ...
    const r = "rtl" === document.dir,
          i = (this.el.shadowRoot || this.el).querySelector(".searchbar-search-icon");
    if (this.shouldAlignLeft) a.removeAttribute("style"), i.removeAttribute("style");else {
      const o = document,
            s = o.createElement("span");
      s.innerText = this.placeholder || "", o.body.appendChild(s), h(() => {
        const o = s.offsetWidth;
        s.remove();
        const t = "calc(50% - " + o / 2 + "px)",
              e = "calc(50% - " + (o / 2 + 30) + "px)";
        r ? (a.style.paddingRight = t, i.style.marginRight = e) : (a.style.paddingLeft = t, i.style.marginLeft = e);
      });
    }
  }
  ...
  positionCancelButton() {
    ...
    if (r && i !== this.isCancelVisible) {
      const o = r.style;
      if (this.isCancelVisible = i, i) a ? o.marginLeft = "0" : o.marginRight = "0";else {
        const i = r.offsetWidth;
        i > 0 && (a ? o.marginLeft = -i + "px" : o.marginRight = -i + "px");
      }
    }
  }
  ...
  render() {
    const a = this.animated && e.getBoolean("animated", !0),
          r = n(this),
          i = this.clearIcon || ("ios" === r ? "close-circle" : "close-sharp"),
          t = this.searchIcon || ("ios" === r ? "search-outline" : "search-sharp"),
          c = "never" !== this.showCancelButton && o("button", {
      "aria-label": "cancel",
      type: "button",
