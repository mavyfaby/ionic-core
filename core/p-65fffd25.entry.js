import { r as t, h as o, H as i, e as n, d as r, f as e, i as s, w as a } from "./p-5701584d.js";
import { b as l, c as d, i as c } from "./p-22f1ceb4.js";
import { c as h } from "./p-502e7dbf.js";
import { t as g } from "./p-267c6fae.js";
import { g as p } from "./p-8c07e320.js";
import { c as b, h as m } from "./p-2722d382.js";
import { a as u, d as f } from "./p-9b28f291.js";
...
const v = class {
  ...
  componentDidLoad() {
    w(() => {
      ...
      d.getBoolean("_testing") || __sc_import_ionic("./p-43f97f21.js").then(t => t.startTapClick(d)), d.getBoolean("statusTap", t) && __sc_import_ionic("./p-f06e83a3.js").then(t => t.startStatusTap()), d.getBoolean("inputShims", A()) && __sc_import_ionic("./p-0a9d6b36.js").then(t => t.startInputShims(d)), d.getBoolean("hardwareBackButton", t) && __sc_import_ionic("./p-2c797579.js").then(t => t.startHardwareBackButton()), __sc_import_ionic("./p-4da9d1ae.js").then(t => t.startFocusVisible());
    });
  }
  ...
  get el() {
    return n(this);
      ...
      A = () => c(window, "ios") && c(window, "mobile"),
      w = t => {
...
const k = class {
  constructor(o) {
    t(this, o), this.isScrolling = !1, this.lastScroll = 0, this.queued = !1, this.cTop = -1, this.cBottom = -1, this.detail = {
      ...
      data: void 0,
      isScrolling: !0
    }, this.fullscreen = !1, this.scrollX = !1, this.scrollY = !0, this.scrollEvents = !1, this.ionScrollStart = r(this, "ionScrollStart", 7), this.ionScroll = r(this, "ionScroll", 7), this.ionScrollEnd = r(this, "ionScrollEnd", 7);
  }
  ...
  resize() {
    this.fullscreen ? e(() => this.readDimensions()) : 0 === this.cTop && 0 === this.cBottom || (this.cTop = this.cBottom = 0, s(this));
  }
  ...
  readDimensions() {
    ...
    (o !== this.cTop || i !== this.cBottom) && (this.cTop = o, this.cBottom = i, s(this));
  }

  onScroll(t) {
    const o = Date.now(),
          i = !this.isScrolling;
    this.lastScroll = o, i && this.onScrollStart(), !this.queued && this.scrollEvents && (this.queued = !0, e(o => {
  ...
  async scrollToPoint(t, o, i = 0) {
    ...
    const s = new Promise(t => r = t),
          a = n.scrollTop,
          l = n.scrollLeft,
          d = null != o ? o - a : 0,
          c = null != t ? t - l : 0,
          h = t => {
      const o = Math.min(1, (t - e) / i) - 1,
            s = Math.pow(o, 3) + 1;
      0 !== d && (n.scrollTop = Math.floor(s * d + a)), 0 !== c && (n.scrollLeft = Math.floor(s * c + l)), s < 1 ? requestAnimationFrame(h) : r();
    };
  ...
  render() {
    const {
      ...
      scrollY: n
          ...
          r = l(this),
          e = this.shouldForceOverscroll(),
          s = "ios" === r && d.getBoolean("experimentalTransitionShadow", !0);
    return this.resize(), o(i, {
      class: Object.assign(Object.assign({}, b(this.color)), {
        [r]: !0,
        "content-sizing": m("ion-popover", this.el),
        overscroll: e
      }),
      style: {
...
const M = t => {
  ...
  async setupCollapsibleHeader(t, o) {
    ...
    const n = S(this.collapsibleMainHeader),
          r = S(this.el);
    n && r && (C(n, !1), n.toolbars.forEach(t => {
      B(t, 0);
      ...
      ((t, o, i) => {
        a(() => {
          ...
          const n = t[0],
                r = n.intersectionRect,
                e = r.width * r.height,
                s = 0 === e && 0 == n.rootBounds.width * n.rootBounds.height,
                a = Math.abs(r.left - n.boundingClientRect.left),
                l = Math.abs(r.right - n.boundingClientRect.right);
          s || e > 0 && (a >= 5 || l >= 5) || (n.isIntersecting ? (C(o, !1), C(i)) : (0 === r.x && 0 === r.y || 0 !== r.width && 0 !== r.height) && (C(o), C(i, !1), B(o.toolbars[0])));
        });
      })(t, n, r);
    }, {
      root: t,
      threshold: [.25, .3, .4, .5, .6, .7, .8, .9, 1]
    }), this.intersectionObserver.observe(r.toolbars[r.toolbars.length - 1].el), this.contentScrollCallback = () => {
      ((t, o, i) => {
        e(() => {
            ...
            ((t = [], o = 1, i = !1) => {
              t.forEach(t => {
                const n = t.ionTitleEl,
                      r = t.innerTitleEl;
                n && "large" === n.size && (r.style.transformOrigin = "left center", r.style.transition = i ? "all 0.2s ease-in-out" : "", r.style.transform = `scale3d(${o}, ${o}, 1)`);
              });
            })(o.toolbars, n);
          });
        });
...
const D = class {
  constructor(o) {
    t(this, o), this.animationEnabled = !0, this.mode = l(this), this.animated = !0, this.ionNavWillLoad = r(this, "ionNavWillLoad", 7), this.ionNavWillChange = r(this, "ionNavWillChange", 3), this.ionNavDidChange = r(this, "ionNavDidChange", 3);
  }
  ...
  async connectedCallback() {
    this.gesture = (await __sc_import_ionic("./p-62e08d42.js")).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), t => this.ani && this.ani.progressStep(t), (t, o, i) => {
      if (this.ani) {
        ...
        let n = t ? -.001 : .001;
        t ? n += p([0, 0], [.32, .72], [0, 1], [1, 1], o)[0] : (this.ani.easing("cubic-bezier(1, 0, 0.68, 0.28)"), n += p([0, 0], [1, 0], [.68, .28], [1, 1], o)[0]), this.ani.progressEnd(t ? 1 : 0, n, i);
      }
  ...
  async setRoot(t, o, i) {
    ...
    const n = this.activeEl,
          r = await u(this.delegate, this.el, t, ["ion-page", "ion-page-invisible"], o);
    return this.activeComponent = t, this.activeEl = r, await this.commit(r, n, i), await f(this.delegate, n), !0;
  }
  ...
  async transition(t, o, i = {}) {
    ...
    const {
      ...
      mode: r
          ...
          e = this.animated && d.getBoolean("animated", !0),
          s = this.animation || i.animationBuilder || d.get("navAnimation");
    return await g(Object.assign({
      mode: r,
      animated: e,
      animationBuilder: s,
      enteringEl: t,
...
const E = class {
  constructor(o) {
    t(this, o), this.ionStyle = r(this, "ionStyle", 7);
  }
  ...
  childrenStyle(t) {
    ...
    Object.keys(i).forEach(t => {
      const o = `toolbar-${t}`,
            s = i[t];
      s !== r[o] && (e = !0), s && (n[o] = !0);
    }), e && (this.childrenStyles.set(o, n), s(this));
  }
...
export { v as ion_app, x as ion_buttons, k as ion_content, j as ion_footer, I as ion_header, D as ion_router_outlet, E as ion_title, Z as ion_toolbar };