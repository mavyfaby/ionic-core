import { n as t, p as o } from "./p-502e7dbf.js";
...
const e = e => {
  ...
  const T = e.getBoolean("animated", !0) && e.getBoolean("rippleEffect", !0),
    ...
    clearTimeout(v), v = void 0, f && (k(!1), f = void 0);
        ...
        E = t => {
    f || void 0 !== l && null !== l.parentElement || (l = void 0, x(i(t), t));
  },
        S = t => {
    x(void 0, t);
  },
    ...
    if (f) {
      if (b.has(f)) throw new Error("internal error");
      f.classList.contains(c) || D(f, i, r), k(!0);
    }

    if (t) {
      const o = b.get(t);
      o && (clearTimeout(o), b.delete(t));
      const e = n(t) ? 0 : a;
      t.classList.remove(c), v = setTimeout(() => {
        D(t, i, r), v = void 0;
      }, e);
    }
    ...
    if (t && e > 0 && !n(o)) {
      const t = setTimeout(() => {
        o.classList.remove(c), b.delete(o);
      }, s);
      b.set(o, t);
  ...
  y.addEventListener("ionScrollStart", t => {
    ...
    l = void 0;
  }), y.addEventListener("ionGestureCaptured", w), y.addEventListener("touchstart", o => {
    p = t(o), E(o);
  }, !0), y.addEventListener("touchcancel", h, !0), y.addEventListener("touchend", h, !0), y.addEventListener("mousedown", o => {
    const e = t(o) - u;
    p < e && E(o);
  }, !0), y.addEventListener("mouseup", o => {
    const e = t(o) - u;
    p < e && S(o);
  }, !0);
},
