...
const d = class {
  constructor(n) {
    t(this, n), this.inputId = `ion-input-${l++}`, this.didBlurAfterEdit = !1, this.hasFocus = !1, this.autocapitalize = "off", this.autocomplete = "off", this.autocorrect = "off", this.autofocus = !1, this.clearInput = !1, this.debounce = 0, this.disabled = !1, this.name = this.inputId, this.readonly = !1, this.required = !1, this.spellcheck = !1, this.type = "text", this.value = "", this.onInput = t => {
      ...
      this.clearInput && !this.readonly && !this.disabled && t && (t.preventDefault(), t.stopPropagation()), this.value = "", this.nativeInput && (this.nativeInput.value = "");
    }, this.ionInput = i(this, "ionInput", 7), this.ionChange = i(this, "ionChange", 7), this.ionBlur = i(this, "ionBlur", 7), this.ionFocus = i(this, "ionFocus", 7), this.ionStyle = i(this, "ionStyle", 7);
  }
