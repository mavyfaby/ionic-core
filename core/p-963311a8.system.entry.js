System.register(["./p-f98a0e28.system.js", "./p-0318c166.system.js", "./p-336ee3a9.system.js", "./p-c2ff8c40.system.js", "./p-6a518496.system.js", "./p-338eb2bf.system.js", "./p-f709d13b.system.js", "./p-44d39326.system.js"], function (t) {
  ...
  var o, n, i, e, a, r, s, d, l, p, c, u, h, g, m, b;
  return {
    setters: [function (t) {
      o = t.r;
      n = t.d;
    ...
    execute: function () {
      const f = (t, o) => {
        ...
        switch (o) {
          case "top":
            i.fromTo("transform", "translateY(-100%)", `translateY(${d})`);
            break;

          case "middle":
            const t = Math.floor(e.clientHeight / 2 - a.clientHeight / 2);
            a.style.top = `${t}px`;
            i.fromTo("opacity", .01, 1);
            break;

          default:
            i.fromTo("transform", "translateY(100%)", `translateY(${r})`);
            break;
        }

        return n.addElement(e).easing("cubic-bezier(.155,1.105,.295,1.12)").duration(400).addAnimation(i);
      };
      ...
      const x = (t, o) => {
        ...
        switch (o) {
          case "top":
            i.fromTo("transform", `translateY(${d})`, "translateY(-100%)");
            break;
          ...
          default:
            i.fromTo("transform", `translateY(${r})`, "translateY(100%)");
            break;
        }

        return n.addElement(e).easing("cubic-bezier(.36,.66,.04,1)").duration(300).addAnimation(i);
      };
      ...
      const w = (t, o) => {
        ...
        return n.addElement(e).easing("cubic-bezier(.36,.66,.04,1)").duration(400).addAnimation(i);
      };
      ...
      const v = t => {
        ...
        n.addElement(e).fromTo("opacity", .99, 0);
        return o.addElement(i).easing("cubic-bezier(.36,.66,.04,1)").duration(300).addAnimation(n);
      };
      ...
      const T = t("ion_toast", class {
        constructor(t) {
          ...
          l(this.el);
          this.didPresent = n(this, "ionToastDidPresent", 7);
          this.willPresent = n(this, "ionToastWillPresent", 7);
          this.willDismiss = n(this, "ionToastWillDismiss", 7);
          this.didDismiss = n(this, "ionToastDidDismiss", 7);
        }
        ...
        async buttonClick(t) {
          ...
          const n = await this.callButtonHandler(t);
        ...
        renderButtons(t, o) {
          ...
          return i("div", {
            ...
            class: "toast-icon"
          }), t.text), n === "md" && i("ion-ripple-effect", {
        ...
        render() {
          ...
          const n = t.filter(t => t.side !== "start");
          const a = r(this);
          const s = {
            "toast-wrapper": true,
          ...
          return i(e, {
            ...
            part: "container"
          }, this.renderButtons(o, "start"), i("div", {
            class: "toast-content"
          }, this.header !== undefined && i("div", {
            class: "toast-header",
            part: "header"
          }, this.header), this.message !== undefined && i("div", {
            class: "toast-message",
            part: "message",
            innerHTML: b(this.message)
