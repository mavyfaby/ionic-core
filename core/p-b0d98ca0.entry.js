import { r as i, d as t, h as n, H as o, e } from "./p-5701584d.js";
import { b as s } from "./p-22f1ceb4.js";
import { d as a, f as r } from "./p-502e7dbf.js";
import { c as h } from "./p-2722d382.js";
const l = class {
  constructor(n) {
    i(this, n), this.inputId = `ion-input-${p++}`, this.didBlurAfterEdit = !1, this.hasFocus = !1, this.autocapitalize = "off", this.autocomplete = "off", this.autocorrect = "off", this.autofocus = !1, this.clearInput = !1, this.debounce = 0, this.disabled = !1, this.name = this.inputId, this.readonly = !1, this.required = !1, this.spellcheck = !1, this.type = "text", this.value = "", this.onInput = i => {
      const t = i.target;
      t && (this.value = t.value || ""), this.ionInput.emit(i);
    }, this.onBlur = () => {
      ...
      this.shouldClearOnEdit() && (this.didBlurAfterEdit && this.hasValue() && "Enter" !== i.key && this.clearTextInput(), this.didBlurAfterEdit = !1);
    }, this.clearTextInput = i => {
      this.clearInput && !this.readonly && !this.disabled && i && (i.preventDefault(), i.stopPropagation()), this.value = "", this.nativeInput && (this.nativeInput.value = "");
    }, this.ionInput = t(this, "ionInput", 7), this.ionChange = t(this, "ionChange", 7), this.ionBlur = t(this, "ionBlur", 7), this.ionFocus = t(this, "ionFocus", 7), this.ionStyle = t(this, "ionStyle", 7);
  }
  ...
  valueChanged() {
    this.emitStyle(), this.ionChange.emit({
  ...
  render() {
    ...
    }), this.clearInput && !this.readonly && !this.disabled && n("button", {
      type: "button",
