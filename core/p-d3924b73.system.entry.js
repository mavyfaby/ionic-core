System.register(["./p-f98a0e28.system.js", "./p-0318c166.system.js", "./p-336ee3a9.system.js", "./p-f709d13b.system.js"], function (t, i) {
  "use strict";
    ...
    execute: function () {
      ...
      const h = t("ion_item_option", class {
        constructor(t) {
          ...
          this.onClick = t => {
            const i = t.target.closest("ion-item-option");
        ...
        render() {
          ...
          return n(s, {
            ...
            class: Object.assign(Object.assign({}, d(this.color)), {
              [r]: true,
      ...
      const u = "ion-item-sliding{display:block;position:relative;width:100%;overflow:hidden;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}ion-item-sliding .item{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.item-sliding-active-slide .item{position:relative;-webkit-transition:-webkit-transform 500ms cubic-bezier(0.36, 0.66, 0.04, 1);transition:-webkit-transform 500ms cubic-bezier(0.36, 0.66, 0.04, 1);transition:transform 500ms cubic-bezier(0.36, 0.66, 0.04, 1);transition:transform 500ms cubic-bezier(0.36, 0.66, 0.04, 1), -webkit-transform 500ms cubic-bezier(0.36, 0.66, 0.04, 1);opacity:1;z-index:2;pointer-events:none;will-change:transform}.item-sliding-active-swipe-end .item-options-end .item-option-expandable{padding-left:100%;-ms-flex-order:1;order:1;-webkit-transition-duration:0.6s;transition-duration:0.6s;-webkit-transition-property:padding-left;transition-property:padding-left}[dir=rtl] .item-sliding-active-swipe-end .item-options-end .item-option-expandable,:host-context([dir=rtl]) .item-sliding-active-swipe-end .item-options-end .item-option-expandable{-ms-flex-order:-1;order:-1}.item-sliding-active-swipe-start .item-options-start .item-option-expandable{padding-right:100%;-ms-flex-order:-1;order:-1;-webkit-transition-duration:0.6s;transition-duration:0.6s;-webkit-transition-property:padding-right;transition-property:padding-right}[dir=rtl] .item-sliding-active-swipe-start .item-options-start .item-option-expandable,:host-context([dir=rtl]) .item-sliding-active-swipe-start .item-options-start .item-option-expandable{-ms-flex-order:1;order:1}";
      const b = 30;
      const w = .55;
      let x;
      const v = t("ion_item_sliding", class {
        constructor(t) {
          e(this, t);
          this.item = null;
          this.openAmount = 0;
        ...
        async connectedCallback() {
          ...
          this.gesture = (await i.import("./p-4dd27c23.system.js")).createGesture({
            el: this.el,
        ...
        async open(t) {
          ...
          t = l(t) ? "end" : "start";
          const e = this.openAmount < 0;
          const n = this.openAmount > 0;

          if (e && i === this.leftOptions) {
            return;
          }

          if (n && i === this.rightOptions) {
            return;
          }
          ...
          requestAnimationFrame(() => {
            ...
            const i = t === "end" ? this.optsWidthRightSide : -this.optsWidthLeftSide;
            x = this.el;
            this.setOpenAmount(i, false);
            this.state = t === "end" ? 8 : 16;
          });
        }
        ...
        canStart(t) {
          const i = document.dir === "rtl";
          const e = i ? window.innerWidth - t.startX < 15 : t.startX < 15;
        ...
        onMove(t) {
          ...
          let i = this.initialOpenAmount - t.deltaX;
          ...
          if (i > this.optsWidthRightSide) {
            e = this.optsWidthRightSide;
            i = e + (i - e) * w;
          } else if (i < -this.optsWidthLeftSide) {
        ...
        onEnd(t) {
          ...
          const s = Math.abs(i) > .3;
          const o = Math.abs(this.openAmount) < Math.abs(e / 2);
          ...
          const r = this.state;
          this.setOpenAmount(e, true);

          if ((r & 32) !== 0 && this.rightOptions) {
            this.rightOptions.fireSwipeEvent();
          } else if ((r & 64) !== 0 && this.leftOptions) {
        ...
        setOpenAmount(t, i) {
          ...
          if (t > 0) {
            this.state = t >= this.optsWidthRightSide + b ? 8 | 32 : 8;
          } else if (t < 0) {
            this.state = t <= -this.optsWidthLeftSide - b ? 16 | 64 : 16;
          } else {
            this.tmr = setTimeout(() => {
              this.state = 2;
              this.tmr = undefined;
