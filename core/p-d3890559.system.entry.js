System.register(["./p-f98a0e28.system.js", "./p-0318c166.system.js"], function (i, e) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      const d = i("ion_slides", class {
        ...
        connectedCallback() {
          if (typeof MutationObserver !== "undefined") {
            const i = this.mutationO = new MutationObserver(() => {
              if (this.swiperReady) {
                this.update();
              }
            });
        ...
        async update() {
          const [i] = await Promise.all([this.getSwiper(), g(this.el)]);
          i.update();
        }

        async updateAutoHeight(i) {
          const e = await this.getSwiper();
          e.updateAutoHeight(i);
        }

        async slideTo(i, e, t) {
          const r = await this.getSwiper();
          r.slideTo(i, e, t);
        }
        ...
        async initSwiper() {
          ...
          const {
            Swiper: t
          } = await e.import("./p-07adf185.system.js");
          await g(this.el);
          const r = new t(this.el, i);
        ...
        normalizeOptions() {
          ...
          const t = !!this.options && !!this.options.on ? this.options.on : {};
          const r = {
            on: Object.assign(Object.assign({}, t), e.on)
          };
          return Object.assign(Object.assign(Object.assign({}, i), this.options), r);
        }
        ...
        render() {
          ...
          }, r("slot", null)), this.pager && r("div", {
            class: "swiper-pagination",
            ref: i => this.paginationEl = i
          }), this.scrollbar && r("div", {
      ...
      const g = i => Promise.all(Array.from(i.querySelectorAll("ion-slide")).map(i => i.componentOnReady()));
