import { r as t, d as i, i as r, h as e, H as o, e as a } from "./p-5701584d.js";
import { b as n } from "./p-22f1ceb4.js";
import "./p-502e7dbf.js";
import { c as s } from "./p-383feea1.js";
import "./p-2c797579.js";
import { B as l, i as c, d, e as p, f as b, g as h, s as g } from "./p-fb3c16cf.js";
import { g as u } from "./p-2722d382.js";
...
const f = t => {
  ...
  return r.addElement(t.querySelector("ion-backdrop")).fromTo("opacity", .01, "var(--backdrop-opacity)").beforeStyles({
    "pointer-events": "none"
  }).afterClearStyles(["pointer-events"]), e.addElement(t.querySelector(".alert-wrapper")).keyframes([{
    offset: 0,
    opacity: "0.01",
    transform: "scale(1.1)"
  }, {
    ...
    opacity: "1",
    transform: "scale(1)"
  }]), i.addElement(t).easing("ease-in-out").duration(200).addAnimation([r, e]);
},
      m = t => {
  const i = s(),
        r = s(),
        e = s();
  return r.addElement(t.querySelector("ion-backdrop")).fromTo("opacity", "var(--backdrop-opacity)", 0), e.addElement(t.querySelector(".alert-wrapper")).keyframes([{
    offset: 0,
    opacity: .99,
    transform: "scale(1)"
  }, {
  ...
  return r.addElement(t.querySelector("ion-backdrop")).fromTo("opacity", .01, "var(--backdrop-opacity)").beforeStyles({
    ...
    opacity: "1",
    transform: "scale(1)"
  }]), i.addElement(t).easing("ease-in-out").duration(150).addAnimation([r, e]);
},
      w = t => {
  const i = s(),
        r = s(),
        e = s();
  return r.addElement(t.querySelector("ion-backdrop")).fromTo("opacity", "var(--backdrop-opacity)", 0), e.addElement(t.querySelector(".alert-wrapper")).fromTo("opacity", .99, 0), i.addElement(t).easing("ease-in-out").duration(150).addAnimation([r, e]);
},
      v = class {
  constructor(r) {
    ...
    }, d(this.el), this.didPresent = i(this, "ionAlertDidPresent", 7), this.willPresent = i(this, "ionAlertWillPresent", 7), this.willDismiss = i(this, "ionAlertWillDismiss", 7), this.didDismiss = i(this, "ionAlertDidDismiss", 7);
  }
  ...
  inputsChanged() {
    const t = this.inputs,
          i = new Set(t.map(t => t.type));
    i.has("checkbox") && i.has("radio") && console.warn(`Alert cannot mix input types: ${Array.from(i.values()).join("/")}. Please see alert docs for more info.`), this.inputType = i.values().next().value, this.processedInputs = t.map((t, i) => ({
      type: t.type || "text",
      name: t.name || `${i}`,
      ...
      checked: !!t.checked,
      disabled: !!t.disabled,
      id: t.id || `alert-input-${this.overlayIndex}-${i}`,
      handler: t.handler,
      min: t.min,
      max: t.max
    }));
  ...
  present() {
    return p(this, "alertEnter", f, k);
  }

  dismiss(t, i) {
    return b(this, t, i, "alertLeave", m, w);
  }
  ...
  rbClick(t) {
    for (const i of this.processedInputs) i.checked = i === t;

    this.activeId = t.id, g(t.handler, t), r(this);
  }

  cbClick(t) {
    t.checked = !t.checked, g(t.handler, t), r(this);
  }

  buttonClick(t) {
    const i = t.role,
          r = this.getValues();
    if (c(i)) return this.dismiss({
      values: r
    }, i);
    const e = this.callButtonHandler(t, r);
    return !1 !== e ? this.dismiss(Object.assign({
      values: r
    }, e), t.role) : Promise.resolve(!1);
  }

  callButtonHandler(t, i) {
    if (t && t.handler) {
      const r = g(t.handler, i);
      if (!1 === r) return !1;
  ...
  getValues() {
    ...
    const t = {};
    return this.processedInputs.forEach(i => {
      t[i.name] = i.value || "";
    }), t;
  }
  ...
  renderCheckbox(t) {
    const i = this.processedInputs,
          r = n(this);
    return 0 === i.length ? null : e("div", {
    ...
    }, t.label)), "md" === r && e("ion-ripple-effect", null))));
  }
  ...
  renderInput(t) {
    ...
    return 0 === i.length ? null : e("div", {
      ...
      placeholder: t.placeholder,
      value: t.value,
      onInput: i => t.value = i.target.value,
      id: t.id,
      disabled: t.disabled,
      tabIndex: 0,
      class: {
  ...
  renderAlertButtons() {
    ...
    return e("div", {
      ...
      class: "alert-button-inner"
    }, t.text), "md" === i && e("ion-ripple-effect", null))));
  }
  ...
  render() {
    const {
      ...
      subHeader: r
          ...
          c = `alert-${t}-msg`;
    let d;
    return void 0 !== i ? d = s : void 0 !== r && (d = l), e(o, {
      role: "dialog",
      "aria-modal": "true",
      style: {
        zIndex: `${2e4 + t}`
      },
      class: Object.assign(Object.assign({}, u(this.cssClass)), {
        [a]: !0,
    ...
    }), this.renderAlertInputs(d), this.renderAlertButtons()));
  }
