import { r as t, h as i, H as o } from "./p-5701584d.js";
import { b as r } from "./p-22f1ceb4.js";
import { o as n, c as a } from "./p-2722d382.js";
const e = class {
  constructor(i) {
    t(this, i), this.button = !1, this.type = "button", this.disabled = !1, this.routerDirection = "forward";
  }
  ...
  renderCard(t) {
    ...
    if (!o) return [i("slot", null)];
    const {
      href: r,
      routerDirection: a
    } = this,
          e = o ? void 0 === r ? "button" : "a" : "div";
    return i(e, Object.assign({}, "button" === e ? {
      type: this.type
    } : {
      ...
      onClick: t => n(r, t, a)
    }), i("slot", null), o && "md" === t && i("ion-ripple-effect", null));
  }
...
export { e as ion_card, s as ion_card_content, d as ion_card_header, c as ion_card_subtitle, l as ion_card_title };