...
const l = class {
  ...
  onStart(t) {
    ...
    if (this.containerTop = h.top, this.containerBottom = h.bottom, this.scrollEl) {
      ...
      this.scrollElInitial = this.scrollEl.scrollTop, this.scrollElTop = t.top + m, this.scrollElBottom = t.bottom - m;
  ...
  autoscroll(t) {
    ...
    let s = 0;
    return t < this.scrollElTop ? s = -u : t > this.scrollElBottom && (s = u), 0 !== s && this.scrollEl.scrollBy(0, s), this.scrollEl.scrollTop - this.scrollElInitial;
  }
