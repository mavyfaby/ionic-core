  ...
  return {
    ...
    execute: function () {
      ...
      const g = t("ion_textarea", class {
        ...
        debounceChanged() {
          this.ionChange = l(this.ionChange, this.debounce);
        }
          ...
          if (t && this.autoGrow) {
            a(() => {
              ...
              if (this.textareaWrapper) {
                this.textareaWrapper.style.height = t.scrollHeight + "px";
              }
            });
          }
        }
