...
import { b as a, c as r } from "./p-22f1ceb4.js";
import { c as s } from "./p-2722d382.js";
const l = class {
  constructor(e) {
    t(this, e), this.keyboardVisible = !1, this.translucent = !1, this.ionTabBarChanged = o(this, "ionTabBarChanged", 7);
  }

  selectedTabChanged() {
    void 0 !== this.selectedTab && this.ionTabBarChanged.emit({
...
const d = class {
  constructor(e) {
    t(this, e), this.disabled = !1, this.selected = !1, this.onKeyUp = t => {
      "Enter" !== t.key && " " !== t.key || this.selectTab(t);
    }, this.onClick = t => {
      this.selectTab(t);
    }, this.ionTabButtonClick = o(this, "ionTabButtonClick", 7);
  }
  ...
  componentWillLoad() {
    void 0 === this.layout && (this.layout = r.get("tabButtonLayout", "icon-top"));
  }
  ...
  render() {
    ...
    return e(i, {
      ...
      class: {
        ...
        "tab-has-label": n,
        "tab-has-icon": o,
        "tab-has-label-only": n && !o,
        "tab-has-icon-only": o && !n,
        [`tab-layout-${b}`]: !0,
        "ion-activatable": !0,
        "ion-selectable": !0,
        "ion-focusable": !0
      ...
      class: "button-inner"
    }, e("slot", null)), "md" === g && e("ion-ripple-effect", {
      type: "unbounded"
    })));
  }
...
export { l as ion_tab_bar, d as ion_tab_button };