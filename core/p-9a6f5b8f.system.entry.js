System.register(["./p-f98a0e28.system.js", "./p-0318c166.system.js", "./p-336ee3a9.system.js", "./p-c2ff8c40.system.js", "./p-6a518496.system.js", "./p-338eb2bf.system.js", "./p-f709d13b.system.js", "./p-44d39326.system.js"], function (t) {
  ...
  var e, i, r, o, a, n, l, s, d, c, p, g, b, m, h, u, x;
  return {
    setters: [function (t) {
      e = t.r;
      i = t.d;
    ...
    execute: function () {
      const f = t => {
        ...
        return e.addElement(t).easing("ease-in-out").duration(200).addAnimation([i, r]);
      };
      ...
      const w = t => {
        ...
        return e.addElement(t).easing("ease-in-out").duration(150).addAnimation([i, r]);
      };
      ...
      const I = t("ion_alert", class {
        constructor(t) {
          ...
          p(this.el);
          this.didPresent = i(this, "ionAlertDidPresent", 7);
          this.willPresent = i(this, "ionAlertWillPresent", 7);
          this.willDismiss = i(this, "ionAlertWillDismiss", 7);
          this.didDismiss = i(this, "ionAlertDidDismiss", 7);
        }

        buttonsChanged() {
          const t = this.buttons;
          this.processedButtons = t.map(t => typeof t === "string" ? {
            text: t,
            role: t.toLowerCase() === "cancel" ? "cancel" : undefined
          } : t);
        }

        inputsChanged() {
          const t = this.inputs;
          const e = new Set(t.map(t => t.type));

          if (e.has("checkbox") && e.has("radio")) {
            console.warn(`Alert cannot mix input types: ${Array.from(e.values()).join("/")}. Please see alert docs for more info.`);
          }
        ...
        present() {
          return g(this, "alertEnter", f, w);
        }

        dismiss(t, e) {
          return b(this, t, e, "alertLeave", k, v);
        }

        onDidDismiss() {
          return m(this.el, "ionAlertDidDismiss");
        }

        onWillDismiss() {
          return m(this.el, "ionAlertWillDismiss");
        }
        ...
        renderCheckbox(t) {
          ...
          }, t.label)), i === "md" && o("ion-ripple-effect", null))));
        }
          ...
          return o("div", {
            ...
            if (t.type === "textarea") {
              return o("div", {
                ...
                class: {
                  "alert-input": true,
                  "alert-input-disabled": t.disabled || false
                }
              }));
            } else {
              return o("div", {
        ...
        renderAlertButtons() {
          ...
          return o("div", {
            ...
            class: "alert-button-inner"
          }, t.text), e === "md" && o("ion-ripple-effect", null))));
        }
