System.register(["./p-f98a0e28.system.js", "./p-0318c166.system.js", "./p-7284b7aa.system.js", "./p-a4ece8fa.system.js", "./p-336ee3a9.system.js", "./p-c2ff8c40.system.js", "./p-007aa45d.system.js", "./p-0f392456.system.js", "./p-ce350344.system.js", "./p-9b5507eb.system.js", "./p-4dd27c23.system.js", "./p-6a518496.system.js", "./p-651dc575.system.js", "./p-338eb2bf.system.js", "./p-44d39326.system.js", "./p-4eab2624.system.js"], function (e, r) {
  ...
  var t, s, i, n, o, a, l, h, f, c, p, d, g, u, m, y;
  return {
    setters: [function (e) {
      t = e.w;
      s = e.r;
    ...
    execute: function () {
      ...
      const k = e => {
        ...
        const o = g().duration(1e3).easing("ease-out");
        const a = g().addElement(s).keyframes([{
          offset: 0,
          opacity: "0.3"
        }, {
          offset: .45,
        ...
        const l = g().addElement(t).keyframes([{
          offset: 0,
        ...
        const h = g().addElement(r).keyframes([{
          offset: 0,
        ...
        if (i && n) {
          const e = g().addElement(i).keyframes([{
            offset: 0,
          ...
          const r = g().addElement(n).keyframes([{
            offset: 0,
      ...
      const S = e => {
        ...
        const t = g().addElement(e).keyframes([{
          offset: 0,
      ...
      const R = e => g().duration(125).addElement(e).fromTo("transform", "translateY(var(--ion-pulling-refresher-translate, 100px))", "translateY(0px)");
      ...
      const L = e("ion_refresher", class {
        ...
        async complete() {
          if (this.nativeRefresher) {
            ...
            if (!this.pointerDown) {
              d(() => d(() => this.resetNativeRefresher(this.elementToTransform, 32)));
            }
          } else {
            this.close(32, "120ms");
          }
        ...
        async cancel() {
          if (this.nativeRefresher) {
            if (!this.pointerDown) {
              d(() => d(() => this.resetNativeRefresher(this.elementToTransform, 16)));
            }
          } else {
            this.close(16, "");
          }
