      ...
      const c = t("ion_tab_bar", class {
        ...
        render() {
          ...
          return i(n, {
            ...
            class: Object.assign(Object.assign({}, l(t)), {
              [a]: true,
      ...
      const p = t("ion_tab_button", class {
        ...
        componentWillLoad() {
          if (this.layout === undefined) {
            this.layout = s.get("tabButtonLayout", "icon-top");
          }
        }
        ...
        render() {
          ...
          return i(n, {
            ...
            id: g !== undefined ? `tab-button-${g}` : null,
            class: {
              [h]: true,
              "tab-selected": c,
              "tab-disabled": t,
            ...
            class: "button-inner"
          }, i("slot", null)), h === "md" && i("ion-ripple-effect", {
            type: "unbounded"
          })));
        }
