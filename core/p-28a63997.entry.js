import { r as t, d as i, h as r, H as e, e as n } from "./p-5701584d.js";
...
const b = class {
  constructor(r) {
    t(this, r), this.noUpdate = !1, this.hasFocus = !1, this.ratioA = 0, this.ratioB = 0, this.debounce = 0, this.name = "", this.dualKnobs = !1, this.min = 0, this.max = 100, this.pin = !1, this.snaps = !1, this.step = 1, this.ticks = !0, this.disabled = !1, this.value = 0, this.clampBounds = t => s(this.min, t, this.max), this.ensureValueInBounds = t => this.dualKnobs ? {
      lower: this.clampBounds(t.lower),
      upper: this.clampBounds(t.upper)
    } : this.clampBounds(t), this.handleKeyboard = (t, i) => {
      let r = this.step;
      r = r > 0 ? r : 1, r /= this.max - this.min, i || (r *= -1), "A" === t ? this.ratioA = s(0, this.ratioA + r, 1) : this.ratioB = s(0, this.ratioB + r, 1), this.updateValue();
    }, this.onBlur = () => {
  ...
  onStart(t) {
    const i = this.rect = this.rangeSlider.getBoundingClientRect(),
          r = t.currentX;
    let e = s(0, (r - i.left) / i.width, 1);
    "rtl" === document.dir && (e = 1 - e), this.pressedKnob = !this.dualKnobs || Math.abs(this.ratioA - e) < Math.abs(this.ratioB - e) ? "A" : "B", this.setFocus(this.pressedKnob), this.update(r);
  }
  ...
  update(t) {
    const i = this.rect;
    let r = s(0, (t - i.left) / i.width, 1);
    "rtl" === document.dir && (r = 1 - r), this.snaps && (r = p(c(r, this.min, this.max, this.step), this.min, this.max)), "A" === this.pressedKnob ? this.ratioA = r : this.ratioB = r, this.updateValue();
  }
  ...
  updateRatio() {
    ...
    this.dualKnobs ? (this.ratioA = p(t.lower, i, r), this.ratioB = p(t.upper, i, r)) : this.ratioA = p(t, i, r);
  }
  ...
  render() {
    ...
    if (this.snaps && this.ticks) for (let r = t; r <= i; r += n) {
      const e = p(r, t, i),
            n = {
        ratio: e,
        active: e >= u && e <= k
    ...
    return h(!0, s, this.name, JSON.stringify(this.getValue()), c), r(e, {
  ...
  return r("div", {
    onKeyDown: t => {
      const r = t.key;
      "ArrowLeft" === r || "ArrowDown" === r ? (d(i, !1), t.preventDefault(), t.stopPropagation()) : "ArrowRight" !== r && "ArrowUp" !== r || (d(i, !0), t.preventDefault(), t.stopPropagation());
    },
    class: {
      "range-knob-handle": !0,
      "range-knob-a": "A" === i,
    ...
    role: "presentation"
      ...
      c = (t, i, r, e) => {
  let n = (r - i) * t;
  return e > 0 && (n = Math.round(n / e) * e + i), s(i, n, r);
},
      p = (t, i, r) => s(0, (t - i) / (r - i), 1);
