import { r as i, i as t, h as e, H as o, e as n, d as r } from "./p-5701584d.js";
import { b as a, c as s } from "./p-22f1ceb4.js";
import { o as l, c as d, h as g } from "./p-2722d382.js";
const h = class {
  constructor(t) {
    i(this, t), this.itemStyles = new Map(), this.multipleInputs = !1, this.button = !1, this.detailIcon = "chevron-forward", this.disabled = !1, this.routerDirection = "forward", this.type = "button";
  }
  ...
  itemStyle(i) {
    ...
    }), a || Object.keys(n).length === Object.keys(r).length || (a = !0), a && (this.itemStyles.set(e, n), t(this));
  }

  componentDidLoad() {
    const i = this.el.querySelectorAll("ion-checkbox, ion-datetime, ion-select, ion-radio"),
          t = this.el.querySelectorAll("ion-input, ion-range, ion-searchbar, ion-segment, ion-textarea, ion-toggle"),
          e = this.el.querySelectorAll("ion-anchor, ion-button, a, button");
    this.multipleInputs = i.length + t.length > 1 || i.length + e.length > 1 || i.length > 0 && this.isClickable();
  }
  ...
  render() {
    const {
      ...
      target: c
          ...
          k = void 0 !== i ? i : "ios" === f && x;
    return this.itemStyles.forEach(i => {
      Object.assign(b, i);
    }), e(o, {
      "aria-disabled": s ? "true" : null,
      class: Object.assign(Object.assign(Object.assign({}, b), d(this.color)), {
        item: !0,
        [f]: !0,
        [`item-lines-${r}`]: void 0 !== r,
        "item-disabled": s,
        "in-list": g("ion-list", this.el),
    ...
    })), v && "md" === f && e("ion-ripple-effect", null)), e("div", {
...
const p = class {
  constructor(t) {
    i(this, t), this.noAnimate = !1, this.ionStyle = r(this, "ionStyle", 7);
  }

  componentWillLoad() {
    this.noAnimate = "floating" === this.position, this.emitStyle();
  }
...
const v = class {
  constructor(t) {
    i(this, t), this.animated = !1;
  }

  render() {
    const i = this.animated && s.getBoolean("animated", !0),
          t = g("ion-avatar", this.el) || g("ion-thumbnail", this.el),
          n = a(this);
    return e(o, {
      class: {
        [n]: !0,
...
v.style = ":host{--background:rgba(var(--background-rgb, var(--ion-text-color-rgb, 0, 0, 0)), 0.065);border-radius:var(--border-radius, inherit);display:block;width:100%;height:inherit;margin-top:4px;margin-bottom:4px;background:var(--background);line-height:10px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;pointer-events:none}span{display:inline-block}:host(.in-media){margin-left:0;margin-right:0;margin-top:0;margin-bottom:0;height:100%}:host(.skeleton-text-animated){position:relative;background:-webkit-gradient(linear, left top, right top, color-stop(8%, rgba(var(--background-rgb, var(--ion-text-color-rgb, 0, 0, 0)), 0.065)), color-stop(18%, rgba(var(--background-rgb, var(--ion-text-color-rgb, 0, 0, 0)), 0.135)), color-stop(33%, rgba(var(--background-rgb, var(--ion-text-color-rgb, 0, 0, 0)), 0.065)));background:linear-gradient(to right, rgba(var(--background-rgb, var(--ion-text-color-rgb, 0, 0, 0)), 0.065) 8%, rgba(var(--background-rgb, var(--ion-text-color-rgb, 0, 0, 0)), 0.135) 18%, rgba(var(--background-rgb, var(--ion-text-color-rgb, 0, 0, 0)), 0.065) 33%);background-size:800px 104px;-webkit-animation-duration:1s;animation-duration:1s;-webkit-animation-fill-mode:forwards;animation-fill-mode:forwards;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite;-webkit-animation-name:shimmer;animation-name:shimmer;-webkit-animation-timing-function:linear;animation-timing-function:linear}@-webkit-keyframes shimmer{0%{background-position:-468px 0}100%{background-position:468px 0}}@keyframes shimmer{0%{background-position:-468px 0}100%{background-position:468px 0}}";
export { h as ion_item, m as ion_item_divider, c as ion_item_group, p as ion_label, b as ion_list, f as ion_list_header, x as ion_note, v as ion_skeleton_text };