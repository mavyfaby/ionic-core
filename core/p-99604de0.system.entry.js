System.register(["./p-f98a0e28.system.js", "./p-0318c166.system.js", "./p-7284b7aa.system.js", "./p-336ee3a9.system.js", "./p-f709d13b.system.js"], function (o) {
  "use strict";

  var t, n, i, r, e, a, s, l, c, d, b, u, h;
  return {
    setters: [function (o) {
      t = o.r;
      n = o.d;
    ...
    execute: function () {
      ...
      const f = o("ion_button", class {
        constructor(o) {
          ...
          this.handleClick = o => {
            if (this.type === "button") {
              b(this.href, o, this.routerDirection);
            } else if (d(this.el)) {
        ...
        get rippleType() {
          const o = this.fill === undefined || this.fill === "clear";
        ...
        render() {
          ...
          const m = c === undefined && this.inItem ? "small" : c;
          const k = d === undefined ? "button" : "a";
          const y = k === "button" ? {
            type: n
          } : {
          ...
          return i(r, {
            ...
            class: Object.assign(Object.assign({}, u(b)), {
              [o]: true,
              [t]: true,
              [`${t}-${g}`]: g !== undefined,
              [`${t}-${m}`]: m !== undefined,
      ...
      const v = o => {
        if (o && typeof document !== "undefined") {
          ...
          if (n && n.nodeName.toLowerCase() === "svg") {
            ...
            n.setAttribute("class", (o + " s-ion-icon").trim());
      ...
      const m = o => {
        if (o.nodeType === 1) {
          ...
          for (let t = 0; t < o.attributes.length; t++) {
            ...
            if (s(n) && n.toLowerCase().indexOf("on") === 0) {
              return false;
            }
          }
      ...
      const z = o("ion_icon", class {
        ...
        loadIcon() {
          if (this.isVisible) {
            ...
            if (o) {
              if (k.has(o)) {
                this.svgContent = k.get(o);
              } else {
                w(o).then(() => this.svgContent = k.get(o));
              }
            }
          }
        ...
        render() {
          ...
          const t = this.flipRtl || this.ariaLabel && (this.ariaLabel.indexOf("arrow") > -1 || this.ariaLabel.indexOf("chevron") > -1) && this.flipRtl !== false;
          return i(r, {
            role: "img",
            class: Object.assign(Object.assign({
              ...
              "flip-rtl": !!t && this.el.ownerDocument.dir === "rtl"
            })
      ...
      const C = () => typeof document !== "undefined" && document.documentElement.getAttribute("mode") || "md";
