      ...
      const l = t("ion_back_button", class {
        constructor(t) {
          ...
          this.onClick = async t => {
            ...
            if (n && (await n.canGoBack())) {
              return n.pop({
                skipIfBusy: true
              });
            }

            return s(this.defaultHref, t, "back");
          };
        }
        ...
        get backButtonIcon() {
          ...
          if (a(this) === "ios") {
            return e.get("backButtonIcon", "chevron-back");
          }

          return e.get("backButtonIcon", "arrow-back-sharp");
        }

        get backButtonText() {
          const t = a(this) === "ios" ? "Back" : null;
          return this.text != null ? this.text : e.get("backButtonText", t);
        }
        ...
        render() {
          ...
          return i(o, {
            ...
            class: Object.assign(Object.assign({}, d(t)), {
              [b]: true,
              button: true,
              "back-button-disabled": r,
