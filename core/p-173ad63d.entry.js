import { r as t, d as o, h as i, H as e, e as n } from "./p-5701584d.js";
import { b as a } from "./p-22f1ceb4.js";
import "./p-502e7dbf.js";
import { c as r } from "./p-383feea1.js";
import "./p-2c797579.js";
import { B as s, i as c, d as l, e as d, f as h, g as b, s as p } from "./p-fb3c16cf.js";
...
const u = t => {
  ...
  return i.addElement(t.querySelector("ion-backdrop")).fromTo("opacity", .01, "var(--backdrop-opacity)").beforeStyles({
    "pointer-events": "none"
  }).afterClearStyles(["pointer-events"]), e.addElement(t.querySelector(".action-sheet-wrapper")).fromTo("transform", "translateY(100%)", "translateY(0%)"), o.addElement(t).easing("cubic-bezier(.36,.66,.04,1)").duration(400).addAnimation([i, e]);
},
      m = t => {
  const o = r(),
        i = r(),
        e = r();
  return i.addElement(t.querySelector("ion-backdrop")).fromTo("opacity", "var(--backdrop-opacity)", 0), e.addElement(t.querySelector(".action-sheet-wrapper")).fromTo("transform", "translateY(0%)", "translateY(100%)"), o.addElement(t).easing("cubic-bezier(.36,.66,.04,1)").duration(450).addAnimation([i, e]);
},
      f = t => {
  const o = r(),
        i = r(),
  ...
  return i.addElement(t.querySelector("ion-backdrop")).fromTo("opacity", "var(--backdrop-opacity)", 0), e.addElement(t.querySelector(".action-sheet-wrapper")).fromTo("transform", "translateY(0%)", "translateY(100%)"), o.addElement(t).easing("cubic-bezier(.36,.66,.04,1)").duration(450).addAnimation([i, e]);
      ...
      k = class {
  constructor(i) {
    t(this, i), this.presented = !1, this.keyboardClose = !0, this.buttons = [], this.backdropDismiss = !0, this.translucent = !1, this.animated = !0, this.onBackdropTap = () => {
    ...
    }, l(this.el), this.didPresent = o(this, "ionActionSheetDidPresent", 7), this.willPresent = o(this, "ionActionSheetWillPresent", 7), this.willDismiss = o(this, "ionActionSheetWillDismiss", 7), this.didDismiss = o(this, "ionActionSheetDidDismiss", 7);
  }

  present() {
    return d(this, "actionSheetEnter", u, f);
  }

  dismiss(t, o) {
    return h(this, t, o, "actionSheetLeave", m, v);
  }
  ...
  render() {
    ...
    return i(e, {
    ...
    }, void 0 !== this.header && i("div", {
      class: "action-sheet-title"
    }, this.header, this.subHeader && i("div", {
      class: "action-sheet-sub-title"
    }, this.subHeader)), r.map(o => i("button", {
      type: "button",
      class: x(o),
    ...
    }), o.text), "md" === t && i("ion-ripple-effect", null)))), n && i("div", {
      ...
      lazy: !1,
      class: "action-sheet-icon"
    }), n.text), "md" === t && i("ion-ripple-effect", null))))));
  }
