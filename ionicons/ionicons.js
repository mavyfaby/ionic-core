...
(function () {
  var doc = document;
  var currentScript = doc.currentScript; // !currentScript
  ...
  if (!currentScript || !currentScript.hasAttribute('nomodule') || !('onbeforeload' in currentScript) || 'onbeforeload' in currentScript && !history.scrollRestoration) {
    ...
    */
    ...
    })(typeof window !== 'undefined' && window); // Figure out currentScript (for IE11, since it does not support currentScript)
