import { g as n } from "./p-00b30bd7.js";
let r;
...
const t = () => {
  ...
  return null;
      ...
      o = (n, r, t, e, i) => (t = "ios" === (t && a(t)) ? "ios" : "md", e && "ios" === t ? n = a(e) : i && "md" === t ? n = a(i) : (n || !r || f(r) || (n = r), l(n) && (n = a(n))), l(n) && "" !== n.trim() ? "" !== n.replace(/[a-z]|-|\d/gi, "") ? null : n : null),
