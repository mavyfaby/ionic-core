...
(function () {
  ...
  function o(t, n, i) {
    ...
    for (var r = t; r;) {
      if (r.nodeType === Node.ELEMENT_NODE) {
        ...
        if ("link" === s && "import" === f.getAttribute("rel")) {
  ...
  function h(t, n, i) {
    ...
    }, e), t.b) for (n = 0; n < f.length; n++) c(t, f[n]);
  ...
  f.prototype.connectedCallback = function (t) {
    ...
    var i = this.j.get(t);
    return i ? i.c : (i = new v(), this.j.set(t, i), this.a.a.get(t) && !this.g.some(function (n) {
  ...
  var E = window.Document.prototype.createElement,
      ...
      S = Object.getOwnPropertyDescriptor(window.Node.prototype, "textContent"),
    ...
    function o(n) {
      return function (e) {
        ...
        for (var f = [], s = 0; s < o.length; s++) {
          var c = o[s];
          if (c instanceof Element && i(c) && f.push(c), c instanceof DocumentFragment) for (c = c.firstChild; c; c = c.nextSibling) r.push(c);else r.push(c);
        }

        for (n.apply(this, o), o = 0; o < f.length; o++) a(t, f[o]);

        if (i(this)) for (o = 0; o < r.length; o++) (f = r[o]) instanceof Element && u(t, f);
      };
    }
  ...
  if (!tt || tt.forcePolyfill || "function" != typeof tt.define || "function" != typeof tt.get) {
    var nt = new f();
    Z = nt, window.HTMLElement = function () {
      function t() {
        ...
        if (0 === i.length) return i = E.call(document, n.localName), Object.setPrototypeOf(i, t.prototype), i.__CE_state = 1, i.__CE_definition = n, c(Z, i), i;
        var e = i[n = i.length - 1];
        if (e === X) throw Error("The HTMLElement constructor was either called reentrantly for this constructor or called multiple times.");
        return i[n] = X, Object.setPrototypeOf(e, t.prototype), c(Z, e), e;
      }
      ...
      r(Document.prototype, "createElement", function (n) {
        ...
        return n = E.call(this, n), c(t, n), n;
      }), r(Document.prototype, "importNode", function (n, i) {
        return n = g.call(this, n, !!i), this.__CE_hasRegistry ? h(t, n) : s(t, n), n;
        ...
        return n = p.call(this, n, i), c(t, n), n;
      }), Y(t, Document.prototype, {
        h: y,
        append: C
      });
    }(), Y(nt, DocumentFragment.prototype, {
      h: T,
      append: j
    }), function () {
      function t(t, e) {
      ...
      r(Node.prototype, "insertBefore", function (t, e) {
        if (t instanceof DocumentFragment) {
          ...
          if (t = A.call(this, t, e), i(this)) for (e = 0; e < o.length; e++) u(n, o[e]);
          return t;
        }

        return o = i(t), e = A.call(this, t, e), o && a(n, t), i(this) && u(n, t), e;
      }), r(Node.prototype, "appendChild", function (t) {
        if (t instanceof DocumentFragment) {
          var e = Array.prototype.slice.apply(t.childNodes);
          if (t = N.call(this, t), i(this)) for (var o = 0; o < e.length; o++) u(n, e[o]);
          return t;
        }

        return e = i(t), o = N.call(this, t), e && a(n, t), i(this) && u(n, t), o;
      }), r(Node.prototype, "cloneNode", function (t) {
        return t = D.call(this, !!t), this.ownerDocument.__CE_hasRegistry ? h(n, t) : s(n, t), t;
        ...
        if (t instanceof DocumentFragment) {
          var o = Array.prototype.slice.apply(t.childNodes);
          if (t = M.call(this, t, e), i(this)) for (a(n, e), e = 0; e < o.length; e++) u(n, o[e]);
          return t;
        }
        ...
        var r = M.call(this, t, e),
            f = i(this);
        return f && a(n, e), o && a(n, t), f && u(n, t), r;
      }), S && S.get ? t(Node.prototype, S) : function (t, n) {
        t.b = !0, t.c.push(n);
      }(n, function (n) {
        t(n, {
          enumerable: !0,
        ...
        Object.defineProperty(t, "innerHTML", {
          ...
          set: function (t) {
            ...
            if (i(this) && (r = [], o(this, function (t) {
              t !== e && r.push(t);
            })), n.set.call(this, t), r) for (var c = 0; c < r.length; c++) {
              var u = r[c];
              1 === u.__CE_state && f.disconnectedCallback(u);
            }
            return this.ownerDocument.__CE_hasRegistry ? h(f, this) : s(f, this), t;
          }
        });
      }
      ...
      function n(t, n) {
        r(t, "insertAdjacentElement", function (t, e) {
          var o = i(e);
          return t = n.call(this, t, e), o && a(f, e), i(t) && u(f, e), t;
        });
      }
      ...
      var f = nt;
      k && r(Element.prototype, "attachShadow", function (t) {
        t = k.call(this, t);
        var n = f;
      ...
      }), L && L.get ? t(Element.prototype, L) : K && K.get ? t(HTMLElement.prototype, K) : function (t, n) {
        t.b = !0, t.f.push(n);
      }(f, function (n) {
        t(n, {
          enumerable: !0,
        ...
        void 0 !== U && (e.before = n(U)), void 0 !== U && (e.after = n(W)), void 0 !== q && r(e, "replaceWith", function (n) {
          ...
          for (var r = [], f = 0; f < e.length; f++) {
            var s = e[f];
            if (s instanceof Element && i(s) && r.push(s), s instanceof DocumentFragment) for (s = s.firstChild; s; s = s.nextSibling) o.push(s);else o.push(s);
          }

          for (f = i(this), q.apply(this, e), e = 0; e < r.length; e++) a(t, r[e]);

          if (f) for (a(t, this), e = 0; e < o.length; e++) (r = o[e]) instanceof Element && u(t, r);
...
}).call(self), "string" != typeof document.baseURI && Object.defineProperty(Document.prototype, "baseURI", {
  enumerable: !0,
  configurable: !0,
  get: function () {
...
}, window.CustomEvent.prototype = window.Event.prototype), t = Event.prototype, n = document, i = window, t.composedPath || (t.composedPath = function () {
...
*/
e = window.Element.prototype).matches && (e.matches = e.msMatchesSelector || e.mozMatchesSelector || e.webkitMatchesSelector || function (t) {
...
}(Element.prototype), "isConnected" in (
/*!
Element.isConnected()
*/
o = Element.prototype) || Object.defineProperty(o, "isConnected", {
  configurable: !0,
  enumerable: !0,
  get: function () {
...
}), "classList" in (r = Element.prototype) || Object.defineProperty(r, "classList", {
  get: function () {
    var t = this,
