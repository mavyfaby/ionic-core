...
function l(n, t, r) {
  var i = function (n, t) {
    ...
    var i = function (n, t) {
      for (var r = 0, i = t; i < n.length; i++) {
        var e = n[i];
        if ("(" === e) r++;else if (")" === e && --r <= 0) return i + 1;
      }

      return i;
    }(n, r.start),
        e = n.substring(r.end, i - 1).split(","),
        u = e[0],
        o = e.slice(1);
  ...
  var e = i.propName,
      u = null != i.fallback ? d(i.fallback) : void 0;
...
function p(n, t) {
  for (var r = !1, i = !1, e = t; e < n.length; e++) {
    var u = n[e];
    if (r) i && '"' === u && (r = !1), i || "'" !== u || (r = !1);else if ('"' === u) r = !0, i = !0;else if ("'" === u) r = !0, i = !1;else {
      if (";" === u) return e + 1;
      if ("}" === u) return e;
    }
  }
...
function d(n) {
  ...
  n = function (n) {
    for (var t = "", r = 0;;) {
      var i = a(c, n, r),
          e = i ? i.start : n.length;
      if (t += n.substring(r, e), !i) break;
      r = p(n, e);
    }
...
function g(n) {
  ...
  for (var r = {}, i = Object.entries(t), e = function () {
    var n = !1;
...
function b(n) {
  ...
  return t && (n = n.substr(0, n.length - "!important".length).trim()), {
    value: n,
    important: t
  };
}
...
function k(a) {
  var f,
      c = function n(r, i) {
    var a = i.substring(r.start, r.end - 1);

    if (r.parsedCssText = r.cssText = a.trim(), r.parent) {
      a = (a = (a = function (n) {
      ...
      }(a = i.substring(r.previous ? r.previous.end : r.parent.start, r.start - 1))).replace(e.multipleSpaces, " ")).substring(a.lastIndexOf(";") + 1);

      var f = r.parsedSelector = r.selector = a.trim();
      r.atRule = 0 === f.indexOf(s), r.atRule ? 0 === f.indexOf(o) ? r.type = t.MEDIA_RULE : f.match(e.keyframesRule) && (r.type = t.KEYFRAMES_RULE, r.keyframesName = r.selector.split(e.multipleSpaces).pop()) : r.type = 0 === f.indexOf(u) ? t.MIXIN_RULE : t.STYLE_RULE;
    }
    ...
    for (var u = e, o = 0, s = t.length; o < s; o++) if (t[o] === r) {
      u.rules || (u.rules = []);
      var a = u,
          f = a.rules[a.rules.length - 1] || null;
      (u = new n()).start = o + 1, u.parent = a, u.previous = f, a.rules.push(u);
    } else t[o] === i && (u.end = o + 1, u = u.parent || e);

    return e;
  }(f = (f = a).replace(e.comments, "").replace(e.port, "")), f),
      v = d(a);
...
function A(n, t, r) {
  var i;
  return i = "." + r, n.replace(new RegExp("\\." + t, "g"), i);
}
...
function O(n, t, r) {
  ...
  return fetch(i).then(function (n) {
    ...
    if (((o = e).indexOf("var(") > -1 || j.test(o)) && r.parentNode) {
      (function (n) {
        return P.lastIndex = 0, P.test(n);
      })(e) && (e = function (n, t) {
        var r = t.replace(/[^/]*$/, "");
        return n.replace(P, function (n, t) {
          return n.replace(t, r + t);
        });
      }(e, i));
      var u = n.createElement("style");
      u.setAttribute("data-styles", ""), u.textContent = e, M(t, u), r.parentNode.insertBefore(u, r), r.remove();
    }
  ...
  return n.prototype.i = function () {
    ...
    return this.didInit || !this.win.requestAnimationFrame ? Promise.resolve() : (this.didInit = !0, new Promise(function (t) {
      n.win.requestAnimationFrame(function () {
        var r, i;
        r = n.doc, i = n.globalScopes, new MutationObserver(function () {
          L(r, i) && R(i);
        }).observe(document.head, {
          childList: !0
        }), function (n, t) {
          return L(n, t), function (n, t) {
            for (var r = [], i = n.querySelectorAll('link[rel="stylesheet"][href]:not([data-no-shim])'), e = 0; e < i.length; e++) r.push(O(n, t, i[e]));
    ...
    var t = this;
    return O(this.doc, this.globalScopes, n).then(function () {
      t.updateGlobal();
    });
  }, n.prototype.addGlobalStyle = function (n) {
    M(this.globalScopes, n) && this.updateGlobal();
  }, n.prototype.createHostStyle = function (n, t, r, i) {
    if (this.hostScopeMap.has(n)) throw new Error("host style already created");
    var e,
        u,
        o,
        s,
        a = this.registerHostTemplate(r, t, i),
        f = this.doc.createElement("style");
    return f.setAttribute("data-no-shim", ""), a.usesCssVars ? i ? (f["s-sc"] = t = a.scopeId + "-" + this.count, f.textContent = "/*needs update*/", this.hostStyleMap.set(n, f), this.hostScopeMap.set(n, (u = t, o = (e = a).template.map(function (n) {
      return "string" == typeof n ? A(n, e.scopeId, u) : n;
    }), s = e.selectors.map(function (n) {
      return Object.assign(Object.assign({}, n), {
        selector: A(n.selector, e.scopeId, u)
      });
    }), Object.assign(Object.assign({}, e), {
      template: o,
      selectors: s,
      scopeId: u
    }))), this.count++) : (a.styleEl = f, a.usesCssVars || (f.textContent = m(a.template, {})), this.globalScopes.push(a), this.updateGlobal(), this.hostScopeMap.set(n, a)) : f.textContent = r, f;
...
!($ = "undefined" != typeof window && window) || $.__cssshim || $.CSS && $.CSS.supports && $.CSS.supports("color", "var(--c)") || ($.__cssshim = new I($, $.document));